...
Install the current release of [FixedPointJAX](https://github.com/esbenscriver/FixedPointJAX) with pip

    pip install FixedPointJAX
    
Install the current release of [JAX](https://jax.readthedocs.io/en/latest/quickstart.html) with pip

    pip install jax

Install the current release of [Simple Pytree](https://github.com/cgarciae/simple-pytree) with pip
